                        ...
                        companions.map((companion) => {
                            ...
                            return (
                                <div key={companion.id} className=' border border-neutral-700 p-4 rounded-xl w-full space-y-2'>
                                    ...
                                    {
                                        isVerified ? <p className=' bg-green-700 text-white w-max px-4 py-0.5 rounded-full'>Verified</p> : <p className='bg-rose-500 text-white w-max px-4 py-0.5 rounded-full'>Unverified</p>
                                    }
