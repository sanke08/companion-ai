...
const Navbar = ({ user }: Props) => {
    return (
        <div className=' w-full flex justify-between h-[65px] z-50 bg-neutral-900  border-b-2 border-neutral-500/20 left-0 fixed top-0 px-7 items-center'>
            <p className=' text-3xl'>companion.ai</p>
            {
                user ?
